...
public class CustomerViewProducts extends JFrame {
	...
	public CustomerViewProducts() throws Exception{
		...
		for (Product prod: productList) {
			...
			if (prod instanceof Mouse) {
				...
				data = new Object[] {barcode, product, mType, brand, colour, conn, quantity, "£ "+retPrice, buttons};
				dtStock.addRow(data);
				...
				data = new Object[] {barcode, product, kType, brand, colour, conn, quantity, "£ "+retPrice, kLayout};
				dtStock.addRow(data);
			}
		}
	}
